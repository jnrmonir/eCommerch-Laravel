...
<form method="POST" action="{{ route('login') }}">
    ...
    <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
        <div class="signin-logo tx-center tx-24 tx-bold tx-inverse"><span class="tx-info tx-normal">Login</span></div>
            <div class="tx-center mg-b-60">Login First</div>
            ...
            <a href="{{ route('githublogin') }}" class="btn btn-outline-dark mt-2 btn-block"><i class="fa fa-github"></i>Login With Github</a>
            <a href="{{ route('googlelogin') }}" class="btn btn-outline-danger mt-2 btn-block"><i class="fa fa-google"></i>Login With Google</a>
