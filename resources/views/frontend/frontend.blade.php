            ...
            <ul class="row">
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>Sale</span>
                            <img src="{{asset('/product/thumbnail/'.$product->thumbnail)}}" alt="{{ $product->title?? "" }}">
                            <div class="product-icon flex-style">
                                <ul>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-flex">
                    ...
                    <div class="product-single-content w-50">
                        ...
                        <p>{{ Str::limit($product->summary, 70 , ' Read More') }}</p>
                        ...
                        <ul class="cetagory">
                            <li>Colors:</li>
                            @foreach (App\Models\ProductAttribute::where('product_id',$product->id)->get() as $color)
                            <li><a href="#">{{ $color->get_color->color_name }}@if (!$loop->last),@endif</a></li>
                            @endforeach
                        </ul>
                        <ul class="socil-icon">
                            <li>Share :</li>
                            <li><a href="https://www.facebook.com/sharer/sharer.php?u={{ route('productdetails',$product->slug) }}"><i class="fa fa-facebook"></i></a></li>
