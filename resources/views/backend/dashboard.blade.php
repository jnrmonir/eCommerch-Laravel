      ...
      <div class="col-sm-6 col-xl-3">
        <div class="card pd-20 bg-primary">
          ...
          <div class="d-flex align-items-center justify-content-between">
            ...
            <h3 class="mg-b-0 tx-white tx-lato tx-bold">{{ $cat_count }}</h3>
          </div><!-- card-body -->
...
<script>
  ...
  var myChart = new Chart(ctx, {
      type: 'pie',
      data: {
          labels: ['ToDay', 'YesterDay', '2 DaysAgo'],
          datasets: [{
              label: '# of Votes',
              data: [{{ $today_user }}, {{ $yester_day_user }}, {{ $two_days_ago }}],
              backgroundColor: [
                  'rgba(255, 99, 132, 0.2)',
                  'rgba(54, 162, 235, 0.2)',
                  'rgba(255, 206, 86, 0.2)',
