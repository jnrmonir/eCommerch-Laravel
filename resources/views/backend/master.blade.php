  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{ route('RoleManager') }}" class="sl-menu-link @yield('permission')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-people-outline tx-20"></i>
            <span class="menu-item-label">Roll Manager</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <a href="#" class="sl-menu-link @yield('category')">
          ...
          <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('CategoryTrashed') }}" class="nav-link"><i class="fa fa-trash"></i>Trash</a></li>
          </ul>
          ...
          <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('SubCategoryTrashed') }}" class="nav-link"><i class="fa fa-trash"></i>Trash</a></li>
          </ul>
          ...
          <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('productlist') }}" class="nav-link"><i class="fa fa-list"></i>List</a></li>
            <li class="nav-item"><a href="{{ route('productadd') }}" class="nav-link"><i class="fa fa-plus"></i>Add</a></li>
            <li class="nav-item"><a href="{{ route('ProductTrashed') }}" class="nav-link"><i class="fa fa-trash"></i>Trash</a></li>
          </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('Order') }}" class="nav-link">All Orders</a></li>         
        </ul>
    ...
    <div class="sl-mainpanel">
      ...
      <footer class="sl-footer">
        <div class="footer-left">
          <div class="mg-b-2">Copyright &copy; 2017-{{ date('Y') }} <!--2017-{{ Carbon\Carbon::now()->format('Y') }}-->. Starlight. All Rights Reserved.</div>
