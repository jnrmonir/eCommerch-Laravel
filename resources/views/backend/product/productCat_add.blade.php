...
<div class="sl-pagebody">
    ...
    <form action="{{ route('ProductPost') }}" enctype="multipart/form-data" method="post">
        @csrf
            ...
            <div class="col-xl-12">
              <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                ...
                <div class="row mg-t-20">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <textarea rows="2" name="summary" class="form-control" placeholder="Enter your summary"></textarea>
                  </div>
                </div>
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">Description: <span class="tx-danger">*</span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                      <textarea rows="2" name="description" class="form-control" placeholder="Enter your description"></textarea>
                    </div>
                  </div>
                  <div class="row mg-t-20">
